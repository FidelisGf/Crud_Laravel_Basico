        ...
        <thead>
         ...
         <tbody>
            ...
            <tr>
                ...
                <td><a href="{{url('editar-produto/'.$item->id)}}" class="btn btn-primary btn-sm">Editar</a></td>
                <td><a href="{{url('deletar-produto/'.$item->id)}}" style="" class="btn btn-primary btn-sm">Deletar</a></td>
            </tr>
             @endforeach
        </tbody>
    </table>
